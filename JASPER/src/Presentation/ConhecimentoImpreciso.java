...
public class ConhecimentoImpreciso extends JFrame {
	...
	private void button1ActionPerformed(ActionEvent e) {
		...
		if(buttonUtente.isSelected()){
			...
			//c = new conheci_impreciso("UTENTE",id,nome,idade,morada);
		}
		if(buttonConsulta.isSelected()){
			...
			//c = new conheci_impreciso(diaConsulta,mesConsulta,anoConsulta,utenteConsulta,serveConsulta,custoConsulta);
		}
		if(buttonServico.isSelected()){
			...
			//c = new conheci_impreciso(idServico,nomeServico,instServico,cidadeServico);
		}
