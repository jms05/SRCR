 ...
 * @author Octavio Maia
 */
public class ConhecimentoIncerto extends JFrame {
	public ConhecimentoIncerto() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		buttonConhecimentoPositivo.setText("Adicionar conhecimento incerto");
